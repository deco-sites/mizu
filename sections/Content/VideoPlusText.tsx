...
export default function VideoPlusText({
  ...
  return (
    <div class="relative w-full h-full">
      {title &&
        (
          <div class="absolute top-0 left-0 w-full h-full flex justify-center items-center" style={{ background: 'rgba(0,0,0,.64)'}}>
      ...
      )}
      {
        ...
        <video loop autoplay muted playsinline class="w-full h-[502px] lg:h-full object-cover">
