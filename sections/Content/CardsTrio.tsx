        ...
        cards.map(card => (
            <div class="min-w-[318px]">
                ...
                <div>
                    {
                        card.title &&
                        <h3 class="font-bold text-[40px] leading-[46.88px] text-[#060606] uppercase pt-[24px] pb-[16px]">{card.title}</h3>
                    }
                    {
                        card.description &&
                        <p class="text-[16px] leading-[18.75px] text-[#060606]">{card.description}</p>
                    }
                    <a
